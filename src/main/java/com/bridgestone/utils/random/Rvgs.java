 ...
 *
 * Name              : lib.Rvgs.java  (Random Variate GeneratorS)
...
public class Rvgs{
    ...
    //
    // There is no good way to use lib.Rvgs along with selectStream because the
    // original implementation had the lib.Rvgs constructor create its own copy
    // of an lib.Rngs object.
    //
    // Instead, force the lib.Rvgs constructor to have an already-created lib.Rngs
    // object.
...
//    }
    ...
    public Rvgs(Rngs givenRngs)
    {
      try {
        ...
        System.out.println("lib.Rvgs constructor requires non-null argument");
      }
      rngs = givenRngs;
    }
    /* Barry Lawson 8 Nov 2007 */
